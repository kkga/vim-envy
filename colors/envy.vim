...
" License:      MPL 2.0
" Last Updated: Thu 03 Dec 2020 01:05:43 PM MSK
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi SpellBad guifg=#af0000 guibg=NONE gui=undercurl cterm=undercurl
  hi SpellCap guifg=#5f00ff guibg=NONE gui=undercurl cterm=undercurl
  hi SpellLocal guifg=#005f00 guibg=NONE gui=undercurl cterm=undercurl
  hi SpellRare guifg=#5f00ff guibg=NONE gui=undercurl cterm=undercurl
  ...
  hi ErrorSign guifg=#af0000 guibg=NONE gui=bold cterm=bold
  hi WarningSign guifg=#d75f00 guibg=NONE gui=bold cterm=bold
  hi ErrorHighlight guifg=#000000 guibg=#ffafaf gui=NONE cterm=NONE
  hi WarningHighlight guifg=#d75f00 guibg=NONE gui=undercurl cterm=undercurl
  hi ErrorMsg guifg=#af0000 guibg=NONE gui=NONE cterm=NONE
  ...
  hi ALEVirtualTextError guifg=#000000 guibg=#ffafaf gui=NONE cterm=NONE
  ...
  hi CocWarningFloat guifg=#000000 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi SpellBad ctermfg=124 ctermbg=NONE cterm=undercurl
  hi SpellCap ctermfg=57 ctermbg=NONE cterm=undercurl
  hi SpellLocal ctermfg=22 ctermbg=NONE cterm=undercurl
  hi SpellRare ctermfg=57 ctermbg=NONE cterm=undercurl
  ...
  hi ErrorSign ctermfg=124 ctermbg=NONE cterm=bold
  hi WarningSign ctermfg=166 ctermbg=NONE cterm=bold
  hi ErrorHighlight ctermfg=16 ctermbg=217 cterm=NONE
  hi WarningHighlight ctermfg=166 ctermbg=NONE cterm=undercurl
  ...
  hi! link ALEWarningSign WarningSign
  hi! link ALEWarning WarningHighlight
  hi ALEVirtualTextError ctermfg=16 ctermbg=217 cterm=NONE
  hi! link CocFloating FloatWindow
  hi! link CocErrorSign ErrorSign
  hi! link CocErrorHighlight ErrorHighlight
  hi! link CocErrorFloat ErrorMsg
  hi! link CocWarningSign WarningSign
  hi! link CocWarningHighlight WarningHighlight
  hi CocWarningFloat ctermfg=16 ctermbg=NONE cterm=NONE
  hi! link cssClassName Keyword
  hi! link cssColor Number
  hi! link cssIdentifier Keyword
  hi! link cssImportant Keyword
